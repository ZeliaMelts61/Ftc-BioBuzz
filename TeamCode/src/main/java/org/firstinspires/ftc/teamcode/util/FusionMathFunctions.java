 ...
 */
public class FusionMathFunctions {
    ...
    public static double getSmallestAngleDifference(double one, double two) {
        return Math.min(FusionMathFunctions.normalizeAngle(one - two), FusionMathFunctions.normalizeAngle(two - one));
    }
    ...
    public static double getTurnDirection(double startHeading, double endHeading) {
        if (FusionMathFunctions.normalizeAngle(endHeading - startHeading) >= 0 && FusionMathFunctions.normalizeAngle(endHeading - startHeading) <= Math.PI) {
