...
public class Drivetrain implements Mechanism {
    ...
    public void manualHoldAngleFieldOriented(double forward, double lateral, double heading, double holdAngleRadians) {
        manualHoldAngleFieldOriented(forward, lateral, heading, follower.pose().heading(), holdAngleRadians);
    }

    /** not recommended */
    public void manualHoldAngleRobotOriented(double forward, double lateral, double heading, double holdAngleRadians){
        DrivePowers powers =
                ManualDrive.headingLock(
                        follower,
                        headingController,
    ...
    public Command manualHoldAngleFieldOrientedCommand(DoubleSupplier forward, DoubleSupplier lateral, DoubleSupplier heading, DoubleSupplier holdAngleRadians){
        return infinite(()-> {
            manualHoldAngleFieldOriented(forward.getAsDouble(),lateral.getAsDouble(),heading.getAsDouble(),holdAngleRadians.getAsDouble());
        }).setEnd((endCondition)->{
            stop();
        }).requiring(this);
    }
    ...
    public Command manualHoldAngleRobotOrientedCommand(DoubleSupplier forward, DoubleSupplier lateral, DoubleSupplier heading, DoubleSupplier holdAngleRadians){
        return infinite(()-> {
            manualHoldAngleRobotOriented(forward.getAsDouble(),lateral.getAsDouble(),heading.getAsDouble(),holdAngleRadians.getAsDouble());
        }).setEnd((endCondition)->{
            stop();
        }).requiring(this);
    }
